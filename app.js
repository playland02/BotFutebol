                ...
                bots.forEach(async (bot) => {
                    ...
                    data.data.forEach((game) => {
                        for (let i = 0; i < params.length; i++) {
                            ...
                            //appm
                            if (game.stats[0] && game.stats[1] &&
                                Object.values(params[i]).includes('appm') &&
                                game.stats[0].attacks && game.stats[1].attacks &&
                            ...
                            //dangerous_attacks
                            if (game.stats[0] && game.stats[1] &&
                                Object.values(params[i]).includes('dangerous_attacks') &&
                                game.stats[0].attacks && game.stats[1].attacks &&
                    ...
                    if (tips.length > 0) {
                        ...
                        const set_tips = new Set(tips)
                        const new_tips = Array.from(set_tips)

                        new_tips.forEach(async (tip) => {
                            ...
                            if (total_tips < 2) {
                                ...
                                const filter_games = await fetch('http://191.252.195.184:3000/tip', config).then((res) => {
                                    return res.json()
                                })
                                ...
                                if (!filter_games.error) {
                                    ...
                                    ctx.telegram.sendMessage(bot.chat_id, `${bot.name}\n
